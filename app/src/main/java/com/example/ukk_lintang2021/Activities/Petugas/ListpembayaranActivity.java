...
public class ListpembayaranActivity  extends AppCompatActivity
    ...
    private void retrieveAndFillRecyclerView(final String action, String queryString,
        ...
        retrievedData.enqueue(new Callback<ResponsePembayaran>() {
            ...
            public void onFailure(Call<ResponsePembayaran> call, Throwable t) {
                ...
                ApiClient.showInfoDialog(ListpembayaranActivity.this, "ERROR", t.getMessage());
            }
        });
    }
    /**
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_new:
                ApiClient.openActivity(this, PembayaranActivity.class);
                finish();
                return true;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listpembayaran);
